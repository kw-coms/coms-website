  ...
  if (variant === 'full') {
    return (
      <button
        ...
        aria-label={label}
        title={label}
        className={`inline-flex min-h-12 items-center justify-center gap-2 rounded-full border px-3 py-3 text-sm font-black transition disabled:opacity-50 sm:px-5 ${
          bookmarked
