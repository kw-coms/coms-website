import { ArrowLeft, CalendarDays, CheckCircle2, Mail, PenLine, Rocket, Users } from 'lucide-react'
  ...
  return (
    <div className="w-full space-y-4">
      ...
      <section className="shape-cut overflow-hidden border border-white/10 bg-white/5 text-[var(--theme-text)] shadow-[0_22px_70px_rgba(255,255,255,0.12)] backdrop-blur-md">
        <div className="border-b border-white/10 bg-emerald-300/8 px-6 py-7 sm:px-8">
        ...
        <article className="bg-[var(--theme-surface-96)] text-[var(--theme-body-dark)]">
          <div className="grid gap-0 lg:grid-cols-[1fr_340px]">
            ...
            <aside className="flex flex-col justify-between gap-8 bg-emerald-950/22 p-6 text-white sm:p-8">
