      ...
      {effectiveOpen && createPortal(
        ...
        >
          <div className="flex items-center justify-between border-b border-[var(--app-hairline)] px-4 py-3">
            ...
            <button type="button" onClick={readAll} className="text-xs font-bold text-[var(--app-accent-text)] hover:underline">모두 읽음</button>
          </div>
              ...
              >
                <span className="flex items-start gap-2">
                  ...
                  <span className="min-w-0 flex-1">
                    ...
                    {item.acceptUrl && (
                      <span className="mt-1 block text-[11px] font-bold text-[var(--app-accent-text)]">눌러서 수락하러 가기 →</span>
                    )}
